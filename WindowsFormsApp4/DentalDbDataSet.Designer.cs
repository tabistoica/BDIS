...
namespace WindowsFormsApp4.DentalDbDataSetTableAdapters {
    ...
    public partial class vedereTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PatId, PatName, PatPhone, PatAddress, PatDOB, PatGender, PatAllergies, Tre" +
                "atment, ApDate, ApTime, TreatDesc, Medicines FROM dbo.vedere";
        ...
        public virtual int Fill(DentalDbDataSet.vedereDataTable dataTable) {
        ...
        public virtual DentalDbDataSet.vedereDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DentalDbDataSet.vedereDataTable dataTable = new DentalDbDataSet.vedereDataTable();
